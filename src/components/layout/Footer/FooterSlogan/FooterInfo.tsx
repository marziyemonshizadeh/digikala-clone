...
type FooterInfoProps = {
  open: boolean;
  handleShowMoreInfo: (e: React.ChangeEvent<HTMLInputElement> | any) => void;
};

function FooterInfo({ open, handleShowMoreInfo }: FooterInfoProps) {
  return (
    <div className="grow px-5">
      <div
        className={`relative lg:ml-10 ml-0 text-neutral-500 text-body-2 overflow-hidden ${
          !open && styles.informationCustomClass
        } ${!open && "h-[200px] "}`}
      >
        <h1>
          <strong>
        ...
        <p>
          ...
          که ممکن است گاهی برای کاربران جدید، مبهم و پیچیده به نظر برسند. برای
        ...
        <p>
          ...
          می‌پردازیم که&nbsp;امکان <strong>ارسال امروز</strong> برای آن ها وجود
          دارد.&nbsp;
        </p>
        ...
        <p>
          ...
          یا حراج جمعه سیاه، در این سال‌ها بیشترین درصد تخفیف در اختیار مشتریان
          دیجی‌کالا قرار گرفته‌است و شامل دسته بندی های مختلف از موبایل و لپ تاپ
          تا عطر و لباس و حتی غذای حیوانات خانگی بوده‌است.&nbsp;
        </p>
        ...
        <p>
          ...
          کیس، کیبورد، مودم از برندهای مختلف مثل&nbsp;مودم
        ...
        <p>
          ...
          بادام‌زمینی،&nbsp;عسل،&nbsp;سس،&nbsp;قهوه،&nbsp;زعفران، شکلات، انواع
          نان و ... از برندهای معتبر و معروفی مثل&nbsp;نستله، نوتلا، استارباکس،
          مزمز، چی توز و ... همگی در اختیار شما هستند و تا رسیدن به آشپزخانه شما
        ...
        <p>
          ...
          ،&nbsp;ماسک صورت، ضد تعریق،&nbsp;ماسک مو&nbsp; و...، انواع لوازم شخصی
          برقی، ست هدیه، بهترین انواع عطر و اسپری،{" "}
          ...
          دیجی‌کالا قرار می‌گیرد. در این بخش برندهای مطرحی مثل اسنس، پنبه ریز،
          سینره و... حضور دارند.همچنین میتوانید انواع مکمل غذایی و دارویی مثل
          داروی مناسب{" "}
          <a href="https://www.digikala.com/landing/common-cold/">سرماخوردگی</a>{" "}
        ...
        <p>
          ...
          از محصولاتی مثل صندلی گیمینگ در بخش صندلی‌ها گرفته تا انواع&nbsp;مبل
          ...
          دیجی‌کالا، برندهای معتبری مثل تفال، اخوان، فیلیپس، ال جی، اسنوا، جی
          پلاس و... حضور دارند.
        </p>
        ...
        <p>
          ...
          بخش‌های این فروشگاه اینترنتی است. انواع کتاب و مجله، کتاب زبان، بازی،
          لوازم تحریر با طرح‌های مختلف مانند دختر کفشدوزکی، سازهایی
          مثل&nbsp;پیانو،&nbsp;سنتور،&nbsp;هنگ درام&nbsp; و... با بهترین قیمت‌ها
          و از بهترین برندها در دسترس شما قرار دارند.
        </p>
        ...
        <p>
          ...
          کوهنوردی، ساک و قمقمه ورزشی و وسایل سفر اربعین و... در این بخش قرار
          می‌گیرند. همچنین شما می‌توانید وسایل مد نظر خود را بر اساس نوع ورزش
          (آبی، هوازی، بدنسازی و...) در دسته‌بندی‌های دیجی‌کالا پیدا کنید.
        </p>
        ...
        <p>
          ...
          <strong>برچسب ها</strong>، امکان مشاهده و خرید انواع محصولات با طرح
          های بومی وجود دارد.&nbsp;&nbsp;دیجی‌کالا همچنین برای اینکه حال و هوای
          عید را به اعضای خود هدیه کند،&nbsp;تقویم ۱۴۰۱، انواع ایده&nbsp;عکس
          پروفایل عید نوروز،&nbsp;آهنگ‌های عید نوروز&nbsp;و موزیک‌های شاد بهاری،
          وسایل مربوط به&nbsp;خانه‌تکانیی و&nbsp;انواع لباس های عید&nbsp; را
          برای شما فراهم کرده است تا بتوانید در کنار خرید خود، از این حال و هوای
      ...
      <button
        className="flex items-center cursor-pointer font-semibold text-cyan-600 user-select-none"
        onClick={(e: React.MouseEvent<HTMLButtonElement, MouseEvent>) =>
          handleShowMoreInfo(e)
        }
      >
        <span>{open ? <>بستن</> : <>مشاهده بیشتر</>}</span>
        <IoIosArrowBack className="text-sm mt-2" />
      </button>
    </div>
  );
}
